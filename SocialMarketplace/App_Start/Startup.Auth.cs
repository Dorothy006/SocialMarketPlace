...
namespace SocialMarketplace
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            // Change the handler when the user is not authorized and is accessing
            // a [Authorize] method from webapi, do not redirect to login, but return 401 unauthorized:
